...
public class TabulatedFunctionDifferentialOperationsWindow extends JDialog {
    ...
    public TabulatedFunctionDifferentialOperationsWindow(JFrame frame, TabulatedDifferentialOperator operationService) {
        ...
        JPanel firstFunctionPanel = createFunctionPanel("Функция", functionTable,
                e -> createFunction(), e -> loadFunction(), e -> saveFunction(1), e -> DeleteValueInTB(firstTableModel, function), e -> InsertValueInTB(firstTableModel, function));
        ...
        differentiateButton.addActionListener(e -> performOperation());
    ...
    private JPanel createResultPanel() {
        ...
        JButton saveButton = createStyledButton("Сохранить", e -> saveFunction(2));
