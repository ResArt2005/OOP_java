...
import ru.ssau.tk.ArtKsenInc.OOP_JAVA.operations.MiddleSteppingDifferentialOperator;
...
class MiddleSteppingDifferentialOperatorTest {
    ...
    void derive() {
        ...
        Assertions.assertEquals(0.15714285714285714, newFunc.apply(10));
        Assertions.assertEquals(0.1428571428571428, newFunc.apply(25));
        Assertions.assertEquals(0.1428571428571428, newFunc.apply(90));
